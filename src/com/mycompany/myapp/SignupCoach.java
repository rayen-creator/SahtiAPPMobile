 ...
 * @author Rayen
 */
public class SignupCoach extends com.codename1.ui.Form {

    public SignupCoach(Form previous) {
        setTitle("Sign up as Coach");
    ...
    public SignupCoach(com.codename1.ui.util.Resources resourceObjectInstance) {
